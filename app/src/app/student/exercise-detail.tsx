...
export default function ExerciseDetailScreen() {
  ...
  const [_currentSet, setCurrentSet] = useState<number | null>(null);
  ...
  return (
    <ScreenLayout>
      ...
      >
        ...
        {/* Sets Tracking */}
        <View className="mb-6">
          <Text className="text-lg font-bold text-foreground mb-3 font-display">Marcar Séries</Text>
          {Array.from({ length: exercise.sets }).map((_, index) => {
            ...
            return (
              <TouchableOpacity
                // biome-ignore lint/suspicious/noArrayIndexKey: set items
              ...
              >
                ...
                >
                  <View className="flex-row items-center flex-1">
                    ...
                    >
                      {isCompleted && <Ionicons name="checkmark" size={16} color="#000000" />}
                    </View>
                    <View className="flex-1">
      ...
      <View className="absolute bottom-0 left-0 right-0 p-6 bg-background/95 border-t border-border">
        <TouchableOpacity onPress={handleMarkComplete} disabled={isCompleted} activeOpacity={0.8}>
          <LinearGradient
          ...
          >
            ...
            />
            <Text
              className={`text-lg font-bold font-display ${isCompleted ? 'text-muted-foreground' : 'text-black'}`}
            >
