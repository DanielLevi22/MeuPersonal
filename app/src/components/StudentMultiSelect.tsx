        ...
        >
          <View style={{ flex: 1 }}>
            {selectedIds.length === 0 ? (
              <Text style={{ color: '#A1A1AA', fontSize: 16 }}>Selecionar alunos (opcional)</Text>
            ) : (
              <View>
                <Text
                  style={{ color: '#FFFFFF', fontSize: 14, fontWeight: '600', marginBottom: 4 }}
                >
                  {selectedIds.length}{' '}
          ...
          >
            ...
            <View style={{ padding: 16 }}>
              ...
              <View style={{ flexDirection: 'row', gap: 8 }}>
                ...
                >
                  <Text style={{ color: '#FF3B3B', fontSize: 13, fontWeight: '600' }}>Limpar</Text>
                </TouchableOpacity>
              </View>
            </View>
                  ...
                  return (
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        <Text style={{ color: '#52525B', fontSize: 13 }}>{student.email}</Text>
                      </View>
                    </TouchableOpacity>
                  );
                })
