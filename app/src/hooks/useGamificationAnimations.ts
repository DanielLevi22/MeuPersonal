...
export function useConfettiAnimation(trigger: boolean) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: Animated refs are stable
  useEffect(() => {
    if (trigger) {
...
export function usePulseAnimation(shouldPulse: boolean = true) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: Animated ref is stable
  useEffect(() => {
