...
export function RegisterScreen() {
  ...
  async function handleRegister() {
    ...
    try {
      ...
      Alert.alert('Erro no Cadastro', err.message || 'Erro desconhecido');
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <ScreenLayout>
      ...
      >
            ...
            >
              <View className="bg-card border-2 border-zinc-700 rounded-2xl p-5 flex-row items-center">
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-zinc-400 text-sm">Treinar e acompanhar meu progresso</Text>
                </View>
        ...
        {step === 'services' && (
          <View className="flex-1">
            <Text className="text-white text-lg font-bold mb-4">Quais serviços você oferece?</Text>
            ...
            <View className="mb-6 gap-y-5">
              ...
              <View className="flex-row gap-3 mt-3">
                <Button
                  label="Voltar"
                  onPress={() =>
                    setStep(accountType === 'professional' ? 'services' : 'account_type')
                  }
                  variant="outline"
                  className="flex-1"
                />
