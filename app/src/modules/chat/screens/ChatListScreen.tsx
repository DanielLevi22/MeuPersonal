      ...
      <View className="bg-zinc-900 rounded-2xl p-4 border border-zinc-800 flex-row items-center">
        ...
        <View className="flex-1">
          ...
          <View className="flex-row items-center justify-between">
            <Text className="text-zinc-400 text-sm font-sans flex-1 mr-2" numberOfLines={1}>
  ...
  return (
    <ScreenLayout>
      ...
      <View className="px-6 pt-4 pb-6">
        <Text className="text-3xl font-extrabold text-white mb-1 font-display">Conversas</Text>
