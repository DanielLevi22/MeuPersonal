...
> = {
  ...
  carb_cycling: {
    ...
    description:
      'Alterra dias de alto e baixo carbo para maximizar ganho de massa e perda de gordura.',
    icon: 'refresh-circle',
  },
  ketogenic: {
    label: 'Cetogênica',
    description:
      'Baixo carbo e alta gordura para forçar o corpo a usar gordura como fonte de energia.',
    icon: 'flame',
  },
