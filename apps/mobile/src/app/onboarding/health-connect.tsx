        ...
        const permissions = {
          permissions: {
            read: [
              ...
              // @ts-ignore
              Ionicons.AppleHealthKit?.Constants?.Permissions?.ActiveEnergyBurned ?? 'ActiveEnergyBurned',
            ],
            write: [],
          },
        };
        ...
        <View className="flex-1 px-8 pt-16 pb-12 justify-between">
            ...
            <View className="flex-1 items-center justify-center -mt-20">
                <View className="flex-row items-center gap-6">
                     ...
                     <View className="w-24 h-24 bg-white rounded-3xl items-center justify-center shadow-2xl overflow-hidden relative">
                         {isIOS ? (
                            <>
                                <LinearGradient colors={['#FF2E63', '#ff6b8b']} className="absolute w-full h-full opacity-10" />
                                <Ionicons name="heart" size={48} color="#FF2E63" />
                            </>
                         ) : (
                            <>
                                <LinearGradient colors={['#00D9FF', '#4facfe']} className="absolute w-full h-full opacity-10" />
            ...
            <View className="w-full">
                ...
                <Text className="text-zinc-400 text-center text-sm font-medium mb-12 px-2 leading-6">
                    Sincronizar seu perfil de saúde agiliza o processo de criar um plano de treino personalizado e salvar seus resultados.
                </Text>
