  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.8)', justifyContent: 'flex-end' }}>
        <View style={{ backgroundColor: '#141B2D', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 12, marginBottom: 24 }}>
            <View style={{ flex: 1 }}>
              ...
              <TextInput
                ...
                style={{ backgroundColor: '#0A0E1A', borderWidth: 2, borderColor: '#1E2A42', borderRadius: 12, padding: 14, color: '#FFFFFF', fontSize: 18, fontWeight: '700', textAlign: 'center' }}
              />
            </View>
            <View style={{ flex: 1 }}>
          ...
          <View style={{ marginBottom: 24 }}>
            ...
            <TextInput
              ...
              placeholderTextColor="#5A6178"
              autoCapitalize="none"
              style={{ backgroundColor: '#0A0E1A', borderWidth: 2, borderColor: '#1E2A42', borderRadius: 12, padding: 16, color: '#FFFFFF', fontSize: 16, marginBottom: 12 }}
            />
          ...
          <TouchableOpacity onPress={handleSave} activeOpacity={0.8} disabled={saving}>
            ...
            >
              {saving ? (
                ...
                <Text style={{ color: '#FFF', fontSize: 16, fontWeight: '700' }}>{initialData ? 'Salvar Alterações' : 'Adicionar Exercício'}</Text>
              )}
            </LinearGradient>
          </TouchableOpacity>
        </View>
