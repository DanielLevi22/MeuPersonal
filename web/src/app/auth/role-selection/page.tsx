    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="relative max-w-4xl w-full mx-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          >
            <div
              className={`absolute inset-0 bg-gradient-to-br from-primary/20 to-transparent transition-opacity rounded-2xl ${
                selectedRoles.includes("personal_trainer")
                  ? "opacity-100"
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Gerencie treinos, alunos e acompanhe a evolução física. Acesso completo às
                  ferramentas de prescrição de exercícios.
                </p>
              </div>
            </div>
          </button>
          ...
          >
            <div
              className={`absolute inset-0 bg-gradient-to-br from-secondary/20 to-transparent transition-opacity rounded-2xl ${
                selectedRoles.includes("nutritionist")
                  ? "opacity-100"
                  : "opacity-0 group-hover:opacity-100"
              }`}
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Prescreva dietas, acompanhe refeições e evolução nutricional. Ferramentas
                  especializadas para nutrição.
                </p>
              </div>
            </div>
          </button>
