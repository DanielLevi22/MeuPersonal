...
import { CreateDietModal, DietCard, ImportDietModal } from "@/nutrition";
    ...
    <div className="space-y-8 relative">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16">
          ...
          <h3 className="text-xl font-semibold text-foreground mb-2">Selecione um aluno</h3>
      ...
      <CreateDietModal isOpen={isCreateModalOpen} onClose={() => setIsCreateModalOpen(false)} />
