...
import { CreatePeriodizationModal, PeriodizationCard } from "@/dashboard";
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!isLoading && periodizations.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-2">Nenhuma periodização criada</h3>
            <p className="text-muted-foreground mb-6 text-center max-w-md">
              Crie sua primeira periodização para começar a planejar os ciclos de treinamento dos
              seus alunos
            </p>
            <button
              onClick={() => setShowCreateModal(true)}
