...
export function DietCreatorPage() {
  ...
  const { data: consent, isLoading: isConsentLoading } = useHealthDataConsent();
  ...
  // Auto-set studentId for member (they create plans for themselves)
  useEffect(() => {
        ...
        <div className="bg-zinc-900/60 backdrop-blur-2xl border border-white/5 rounded-[32px] p-4 flex items-center justify-between shadow-2xl shadow-black/50">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              type="submit"
              disabled={
                createMutation.isPending || isConsentLoading || !name || (!isMember && !studentId)
              }
          ...
          >
            <div className="bg-zinc-900/40 border border-white/5 rounded-[40px] p-8 space-y-6">
              ...
              <div className="space-y-6">
                ...
                {/* Student picker — hidden for members (they create plans for themselves) */}
                {!isMember && (
