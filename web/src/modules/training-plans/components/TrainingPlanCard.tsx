      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            <span
              className={`px-3 py-1 rounded-full text-xs font-bold border ${statusColors[trainingPlan.status]}`}
            >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg
              className="w-5 h-5 text-muted-foreground hover:text-secondary"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
