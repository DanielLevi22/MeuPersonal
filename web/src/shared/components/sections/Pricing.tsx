      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-4">
            <span
              className={`text-sm ${!isAnnual ? "text-foreground font-bold" : "text-muted-foreground"}`}
            >
              Mensal
            </span>
            <button
            ...
            >
              <div
                className={`absolute top-1 w-5 h-5 bg-primary rounded-full transition-all ${isAnnual ? "left-8" : "left-1"}`}
              />
            </button>
            <span
              className={`text-sm ${isAnnual ? "text-foreground font-bold" : "text-muted-foreground"}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-surface border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all">
            ...
            <button
              type="button"
              className="w-full py-3 border border-white/10 rounded-xl hover:bg-white/5 transition-colors"
            >
              Começar Grátis
            </button>
          </div>
